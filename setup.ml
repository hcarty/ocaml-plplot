...
(* OASIS_START *)
(* DO NOT EDIT (digest: 236da6a791db30c3e790f14ce81cafad) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-plplot/";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-g"; "-O2"])];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true, []);
                           (OASISExpr.EBool false, ["-fake"])
                        ];
                   ...
                   },
                   {
                      lib_modules = ["Plplot"];
                      lib_pack = false;
                      lib_internal_modules = ["Plplot_core"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "plplot";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-plplot.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-plplot";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "ö\027ÀÝg2½ÖóTrpá¼À\149";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
